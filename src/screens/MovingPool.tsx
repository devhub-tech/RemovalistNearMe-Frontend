...
import MovingPoolContent from "../components/MovingPoolContent";
    ...
    <>
      <Fragment>
        <Suspense fallback={<Preloader />}>
          ...
          {/* Breadcrumb */}
          <Breadcrumb
            title={"MOVING POOL TABLE"}
            img={'url("assets/img/quote/quote-cat-7.jpg")'}
          />
            ...
            <div className="row justify-content-center">
              <div className="col-lg-6">
                <div className="section-title text-center">
                  ...
                  <h2 className="title">MOVING POOL TABLE</h2>
