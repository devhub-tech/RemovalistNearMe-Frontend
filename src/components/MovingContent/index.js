...
const rooms = [
  {
    ...
    items: [
      {
        name: "Baby Bassinette",
        count: 0,
        volume_cubic_meters: 0.2,
        total_volume: 0,
      },
      {
        name: "Baby Bath",
        count: 0,
        volume_cubic_meters: 0.1,
        total_volume: 0,
      },
      {
      ...
      {
        name: "Baby Cot - Assembled",
        count: 0,
        volume_cubic_meters: 0.5,
        total_volume: 0,
      },
      {
        name: "Baby Cot - Dismantled",
        count: 0,
        volume_cubic_meters: 0.3,
        total_volume: 0,
      },
      {
        name: "Bed & Mattress - Bunks",
        count: 0,
        volume_cubic_meters: 1.0,
        total_volume: 0,
      },
      {
        name: "Bed & Mattress - Double",
        count: 0,
      ...
      },
      {
        ...
        count: 0,
        volume_cubic_meters: 1.4,
        total_volume: 0,
      },
      {
        name: "Bed & Mattress - Queen",
        count: 0,
        volume_cubic_meters: 1.3,
        total_volume: 0,
      },
      {
        name: "Bed & Mattress - Single",
        count: 0,
        volume_cubic_meters: 0.8,
        total_volume: 0,
      },
      {
        name: "Bed & Mattress - Trundle",
        count: 0,
      ...
      { name: "Chair", count: 0, volume_cubic_meters: 0.2, total_volume: 0 },
      { name: "Chest", count: 0, volume_cubic_meters: 0.6, total_volume: 0 },
      {
      ...
      { name: "Desk", count: 0, volume_cubic_meters: 0.8, total_volume: 0 },
      {
        name: "Desk - Corner",
        count: 0,
        volume_cubic_meters: 1.0,
      ...
      { name: "Lamp", count: 0, volume_cubic_meters: 0.05, total_volume: 0 },
      { name: "Lowboy", count: 0, volume_cubic_meters: 0.4, total_volume: 0 },
      { name: "Mirror", count: 0, volume_cubic_meters: 0.2, total_volume: 0 },
      {
        name: "Outdoor Lounge - 2 Seater",
        count: 0,
        volume_cubic_meters: 0.8,
        total_volume: 0,
      },
      ...
      { name: "TV", count: 0, volume_cubic_meters: 0.3, total_volume: 0 },
      { name: "Tallboy", count: 0, volume_cubic_meters: 0.8, total_volume: 0 },
      { name: "Toy Box", count: 0, volume_cubic_meters: 0.4, total_volume: 0 },
      {
        name: "Wardrobe - Double Door",
        count: 0,
        volume_cubic_meters: 1.0,
        total_volume: 0,
      },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Stool", count: 0, volume_cubic_meters: 0.1, total_volume: 0 },
    ],
  },
  {
    ...
    items: [
      ...
      { name: "Cabinet", count: 0, volume_cubic_meters: 0.9, total_volume: 0 },
      {
        name: "Dining Chairs",
        count: 0,
        volume_cubic_meters: 0.2,
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Bar", count: 0, volume_cubic_meters: 1.0, total_volume: 0 },
      { name: "Bean Bag", count: 0, volume_cubic_meters: 0.3, total_volume: 0 },
      { name: "Bookcase", count: 0, volume_cubic_meters: 0.5, total_volume: 0 },
      {
        name: "China Cabinet",
        count: 0,
        volume_cubic_meters: 1.0,
      ...
      {
        name: "Lounge - 2.5 Seater",
        count: 0,
        volume_cubic_meters: 1.3,
        total_volume: 0,
      },
      {
        name: "Lounge - 3 Seater",
        count: 0,
        volume_cubic_meters: 1.5,
        total_volume: 0,
      },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Cupboard", count: 0, volume_cubic_meters: 0.5, total_volume: 0 },
      { name: "Dryer", count: 0, volume_cubic_meters: 0.4, total_volume: 0 },
      {
        name: "Ironing Board",
        count: 0,
        volume_cubic_meters: 0.2,
  ...
  },
  {
    ...
    number: "Seven",
    items: [
      { name: "Barbeque", count: 0, volume_cubic_meters: 0.6, total_volume: 0 },
      {
        name: "Garden Bench Seat",
        count: 0,
        volume_cubic_meters: 0.5,
        total_volume: 0,
      },
      ...
      {
        name: "Pot Plants - Large",
        count: 0,
        volume_cubic_meters: 0.3,
        total_volume: 0,
      },
      {
        name: "Pot Plants - Small",
        count: 0,
        volume_cubic_meters: 0.1,
        total_volume: 0,
      },
      { name: "Spa", count: 0, volume_cubic_meters: 2.0, total_volume: 0 },
      {
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Chairs", count: 0, volume_cubic_meters: 0.2, total_volume: 0 },
      { name: "Esky", count: 0, volume_cubic_meters: 0.2, total_volume: 0 },
      {
        name: "Fridge / Freezer",
        count: 0,
        volume_cubic_meters: 0.8,
      ...
      { name: "Jetski", count: 0, volume_cubic_meters: 1.2, total_volume: 0 },
      { name: "Ladder", count: 0, volume_cubic_meters: 0.5, total_volume: 0 },
      {
        name: "Lawn Mower",
        count: 0,
        volume_cubic_meters: 0.5,
      ...
      { name: "Tool Box", count: 0, volume_cubic_meters: 0.2, total_volume: 0 },
      {
        name: "Tool Chest",
        count: 0,
        volume_cubic_meters: 0.4,
      ...
      { name: "Welder", count: 0, volume_cubic_meters: 0.3, total_volume: 0 },
      {
        name: "Wheel Barrow",
        count: 0,
        volume_cubic_meters: 0.4,
  ...
  },
  {
    ...
    number: "Eleven",
    items: [
      { name: "Bench", count: 0, volume_cubic_meters: 0.6, total_volume: 0 },
      {
        name: "Boxing Bag",
        count: 0,
        volume_cubic_meters: 0.3,
...
const MovingContent = () => {
  ...
  const incrementCount = (roomIndex, itemIndex) => {
    ...
    item.count += 1;
    item.total_volume = item.count * item.volume_cubic_meters;
