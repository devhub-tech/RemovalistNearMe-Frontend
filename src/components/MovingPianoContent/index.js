...
import styles from "./MovingPianoContent.module.sass";
...
const rooms = [{ name: "Paino Items", number: "One", items: [] }];

const MovingPianoContent = () => {
...
export default MovingPianoContent;
