                ...
                <div className="row">
                  <div className="col-lg-8">
                      ...
                      <div className="col-lg-4">
                        <div className="single-select-inner style-border">
                          <select className="single-select">
                            ...
                            <option value={1}>Single Item Relocation</option>
                            <option value={2}>House Move</option>
                            <option value={3}>Commercial Move</option>
                          </select>
                        </div>
                      </div>
                      <div className="col-xl-4 col-lg-8">
                        <div className="single-input-inner style-border">
                          <input type="text" placeholder="Pick Suburb" />
                        </div>
                      </div>
                    ...
                    <div className="row">
                      <div className="col-xl-4 col-lg-8">
                        <div className="single-input-inner style-border">
                          <input type="text" placeholder="Drop-off Suburb" />
                        </div>
                      </div>
                      <div className="col-xl-4 col-lg-12">
                        <div className="single-select-inner style-border">
