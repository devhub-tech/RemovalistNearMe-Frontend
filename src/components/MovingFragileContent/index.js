...
import styles from "./MovingFragileContent.module.sass";
...
const rooms = [{ name: "Fragile Items", number: "One", items: [] }];

console.log(rooms);
const MovingFragileContent = () => {
...
export default MovingFragileContent;
