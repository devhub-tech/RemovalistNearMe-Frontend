      ...
      <header className="navbar-area">
        <div className="navbar-top">
          <Link className="main-logo" to="/home">
            <div className="logo d-none d-xl-block">
              <img src="/assets/img/brand-logo2.png" alt="Transpro" />
            </div>
          </Link>
        ...
        >
          <div className="container nav-container">
            ...
            <div className="logo">
              <Link to="/">
                <img src="assets/img/logo-main.jpeg" alt="RemovalistNearMe" />
              </Link>
            </div>
              ...
              <ul className="navbar-nav menu-open">
                <li className="menu-item-has-children current-menu-item">
                  ...
                  <ul className="sub-menu">
                    ...
                    <li>
                      <Link to="/home-2">Removalist for Interstate</Link>
                    </li>
                    <li>
                      <Link to="/home-3">
                        Removalist for Commercial Services
                      </Link>
                    </li>
                  </ul>
                </li>
