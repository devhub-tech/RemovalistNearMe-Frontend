...
const rooms = [
  {
    ...
    number: "One",
    items: [
      { name: "Boardroom Table - 10+ Seater", count: 0 },
      { name: "Boardroom Table - 4 Seater", count: 0 },
      { name: "Boardroom Table - 6 Seater", count: 0 },
      { name: "Boardroom Table - 8 Seater", count: 0 },
      { name: "Bookshelf", count: 0 },
      { name: "Corner Desk", count: 0 },
      { name: "Desk - 2 Seater", count: 0 },
      { name: "Desk - Corner", count: 0 },
      { name: "Desk - Single Seater", count: 0 },
      { name: "Executive Office Chair", count: 0 },
      { name: "Filing Cabinet - 2 Drawer", count: 0 },
      { name: "Filing Cabinet - 3 Drawer", count: 0 },
      { name: "Filing Cabinet - 4 Drawer", count: 0 },
      { name: "Whiteboard", count: 0 },
    ],
  },
